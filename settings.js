    ...
    var gui = new dat.GUI();
    	...
    	var guiFolderWorld = gui.addFolder("World building");
            ...
            var guiFolderBoundary = guiFolderWorld.addFolder("Universe boundary");
                ...
                guiFolderBoundary.add(this, "spaceBoundaryX").name("Size, X").onChange(function(value) { if (boxMesh) boxMesh.scale.x = spaceBoundaryX / originalSpaceBoundaryX; });
                guiFolderBoundary.add(this, "spaceBoundaryY").name("Size, Y").onChange(function(value) { if (boxMesh) boxMesh.scale.y = spaceBoundaryY / originalSpaceBoundaryY; });
                guiFolderBoundary.add(this, "spaceBoundaryZ").name("Size, Z").onChange(function(value) { if (boxMesh) boxMesh.scale.z = spaceBoundaryZ / originalSpaceBoundaryZ; });
        ...
        var guiFolderPlotting = gui.addFolder("Plotting");    //toggles for Plotting:
            ...
            var guiFolderTrajectories = guiFolderPlotting.addFolder("Particle trajectories");
	        	guiFolderTrajectories.add(this, "maxTrajectoryLength").onChange(function(value) {}); //TODO
            	guiFolderTrajectories.add(this, "if_showTrajectory").name("Trajectories");
            ...
            var guiFolderArrows = guiFolderPlotting.addFolder("Arrows for forces and velocities");
                ...
                guiFolderArrows.add(this, "if_limitArrowsMaxLength").name("Limit arrows' max length");
                guiFolderArrows.add(this, "maxArrowLength").name("Arrows' max length");
                guiFolderArrows.add(this, "unitArrowLength").name("Arrows' unit length");
