...
function initializeGuiControls() {
  ...
  guiFolderBoundary
    .add(this, "if_use_periodic_boundary_condition")
    .name("Use PBC")
  ...
  guiFolderPlotting
    .add(this, "if_ReferenceFrame_movesWithSun")
    .name("Center the sun");
  ...
  guiFolderArrows
    .add(this, "if_showMapscale")
    .name("Show scales")
    .onChange(function (value) {
      $(".mapscale").toggle();
    });
  guiFolderArrows
    .add(this, "if_proportionate_arrows_with_vectors")
